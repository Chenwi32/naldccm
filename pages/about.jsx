import { Box, Container, Heading, Image, ListItem, Text, UnorderedList } from "@chakra-ui/react";

const About = () => {
  return (
    <Container minH={"70vh"} maxW={900}>
      <Image
      ...
      <Box mt={20}>
        ...
        <Text mt={5}>
          The company went operational in 2013 as a Common Initiative Group with
          the aim of bringing farmers under a common canopy, forming a
        ...
        <UnorderedList mt={5}>
          ...
          <ListItem>
            Knowledge transmission through workshops, seminars, world cafés, to
            build and empower members’ capacities;
          </ListItem>
          <ListItem>
        ...
        <Text mt={10}>
          ...
          embarked on general supplies, Building/Construction, Opening of farms,
          Training sessions, Import and Exportation. In 2022, we are finally
          settling on NALDCCAM with key operations tilted towards green
          agriculture, prosperous livestock, agro-processing, knowledge
      ...
      <Box mt={10}>
        ...
        <Text mt={5}>
          To improve rural livelihoods and sustainable food system through value
          addition, offering affordable, mechanized agricultural equipment to
          small and medium scale farmers in order to increase green agricultural
          production and a prosperous livestock sector in the country.
        </Text>
      ...
      <Box mt={10}>
        ...
        <UnorderedList mt={5}>
          ...
          <ListItem>
            To create a favorable policy and legal framework for the sustainable
            development of the livestock industry;{" "}
          </ListItem>
          <ListItem>
            To stay consistent, build trust, and establish sustainable business
            relationships with customers while capitalizing on green
